...
//#Pok, levels, ID'S...
  ...
  { 4,   8, 10, POKEMON_GEODUDE, POKEMON_ZUBAT, POKEMON_CLEFAIRY, POKEMON_PARAS }, //Map #10 Mt Moon
  { 3,   9, 12, POKEMON_VULPIX, POKEMON_EKANS, POKEMON_MANKEY } //Map #11 Cerulean City
};
