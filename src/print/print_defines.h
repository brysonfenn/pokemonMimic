...
#define BATTLE_BOX_Y 1
#define BATTLE_BOX_WIDTH 58
#define BATTLE_BOX_HEIGHT 13
...
#define BATTLE_BOX_PLAYER_Y (BATTLE_BOX_Y+7)
...
#define FORCED_ENEMY_MOVE 2
#define DISABLE_TRAINER_ENCOUNTERS false
