...
Region_loc region_list[MAX_MAP_NUM+1] = {
    ...
    {MAP_R3, "Route 3", 18, 7, MAP_MT_MOON_S, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, true},
    {MAP_MT_MOON_N, "Mt. Moon", 24, 4, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, false},
    {MAP_CER_CITY, "Cerulean City", 36, 4, MAP_GENERIC, MAP_GENERIC, MAP_SAFF_CITY, MAP_GENERIC, true},
    {MAP_GYM2, "LOCATION NOT FOUND", 0, 0, MAP_CER_CITY, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, false},
    {MAP_R4, "Route 4", 36, 1, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, false},
    {MAP_UNDERGROUND, "Underground", 36, 7, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, false},
    {MAP_VERM_CITY, "Vermillion City", 36, 11, MAP_SAFF_CITY, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, true},
    {MAP_R5, "Route 5", 42, 1, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, false},
    ...
    {MAP_MT_MOON_S, "Mt. Moon", 18, 4, MAP_MT_MOON_N, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, false},
    ...
    {MAP_CEL_CITY, "Celadon City", 0, 0, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, true},
    ...
    {MAP_FU_CITY, "Fuschia City", 0, 0, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, true},
    ...
    {MAP_SAFF_CITY, "Saffron City", 36, 7, MAP_CER_CITY, MAP_GENERIC, MAP_VERM_CITY, MAP_GENERIC, true},
    {MAP_GYM6, "LOCATION NOT FOUND", 0, 0, MAP_SAFF_CITY, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, false},
    {MAP_CIN_ISLAND, "Cinnabar Island", 0, 0, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, MAP_GENERIC, true},
...
void handle_region_map() {
    ...
    while (1) {
        ...
        else if (ch == KEY_UP) region_loc = region_list[region_loc.up_map];
        else if (ch == KEY_LEFT) region_loc = region_list[region_loc.left_map];
        else if (ch == KEY_DOWN) region_loc = region_list[region_loc.down_map];
        else if (ch == KEY_RIGHT) region_loc = region_list[region_loc.right_map];
    }
