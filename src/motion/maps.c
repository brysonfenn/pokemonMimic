...
//  #Pok, levels, ID'S...
    ...
    { 10,  30, 39, POKEMON_RATTATA, POKEMON_RATTATA, POKEMON_RATICATE, POKEMON_RATICATE, POKEMON_GROWLITHE, 
                    POKEMON_GROWLITHE, POKEMON_GRIMER, POKEMON_GRIMER, POKEMON_DITTO, POKEMON_MUK },         //#26 Mansion 1
    { 10,  32, 40, POKEMON_RATTATA, POKEMON_PONYTA, POKEMON_RATICATE, POKEMON_RATICATE, POKEMON_GROWLITHE, 
                    POKEMON_GRIMER, POKEMON_GRIMER, POKEMON_DITTO, POKEMON_WEEZING, POKEMON_MUK },         //#27 Mansion 2
    { 10,  35, 41, POKEMON_RATTATA, POKEMON_RATICATE, POKEMON_RATICATE, POKEMON_PONYTA, POKEMON_PONYTA, 
                    POKEMON_RAPIDASH, POKEMON_MAGMAR, POKEMON_VULPIX, POKEMON_VULPIX, POKEMON_DITTO },         //#28 Mansion 3
    { 10,  38, 43, POKEMON_DITTO, POKEMON_DITTO, POKEMON_DITTO, POKEMON_DITTO, POKEMON_DITTO, 
                    POKEMON_GROWLITHE, POKEMON_ARCANINE, POKEMON_DITTO, POKEMON_MAGMAR, POKEMON_NINETALES },         //#29 Mansion 4
};

static Pokemon_id water_pok_lists[32][16] = {
//  #Pok, levels, ID'S...
    { 2,   15, 20, POKEMON_MAGIKARP, POKEMON_TENTACOOL }, //#0 Default Water
    // { 1,   34, 34,  POKEMON_GOLBAT }, //#0 Test Pokemon
    ...
    *draw_map = draw_funcs[map_num];
    ...
    switch (player.loc->map) {
        ...
        case MAP_GYM8:
            ...
            break;
        case MAP_SILPH1:
            sprintf(map_name, "silph1");
            break;
        case MAP_SILPH2:
            sprintf(map_name, "silph2");
            break;
        case MAP_SILPH3:
            sprintf(map_name, "silph3");
            break;
        case MAP_SILPH4:
            sprintf(map_name, "silph4");
            break;
        case MAP_SILPH5:
            sprintf(map_name, "silph5");
            break;
        case MAP_SILPH6:
