...
//  #Pok, levels, ID'S...
    ...
    { 4,  15, 19, POKEMON_TAUROS, POKEMON_PINSIR, POKEMON_DODUO, POKEMON_FARFETCHD },         //#15 Route 8
    { 4,  16, 19, POKEMON_GEODUDE, POKEMON_ZUBAT, POKEMON_MACHOP, POKEMON_ONIX },         //#16 Rock Tunnel
    { 4,  17, 20, POKEMON_GASTLY, POKEMON_GASTLY, POKEMON_GASTLY, POKEMON_HAUNTER },         //#17 Pokemon Tower
    { 4,  19, 21, POKEMON_KRABBY, POKEMON_SHELLDER, POKEMON_RHYHORN, POKEMON_GROWLITHE }         //#18 Route 12
};

//     POKEMON_BUTTERFREE, POKEMON_BEEDRILL, POKEMON_PIDGEOT, POKEMON_RATICATE, POKEMON_FEAROW, 
//     POKEMON_ARBOK, POKEMON_RAICHU, POKEMON_SANDSLASH, POKEMON_NIDORINA, POKEMON_NIDOQUEEN, POKEMON_NIDORINO, POKEMON_NIDOKING, 
//     POKEMON_CLEFABLE, POKEMON_NINETALES, POKEMON_WIGGLYTUFF, POKEMON_GOLBAT, POKEMON_GLOOM, POKEMON_VILEPLUME, POKEMON_PARASECT, 
//     POKEMON_VENONAT, POKEMON_VENOMOTH, POKEMON_DUGTRIO, POKEMON_PERSIAN, POKEMON_PSYDUCK, POKEMON_GOLDUCK, 
...
//     POKEMON_MAGNEMITE, POKEMON_MAGNETON, POKEMON_DODRIO, POKEMON_SEEL, POKEMON_DEWGONG, POKEMON_GRIMER, POKEMON_MUK, POKEMON_CLOYSTER, 
//     POKEMON_GENGAR, POKEMON_HYPNO, POKEMON_KINGLER, POKEMON_VOLTORB, POKEMON_ELECTRODE, POKEMON_EXEGGCUTE, 
//     POKEMON_EXEGGUTOR, POKEMON_CUBONE, POKEMON_MAROWAK, POKEMON_HITMONLEE, POKEMON_HITMONCHAN, POKEMON_LICKITUNG,
...
//     POKEMON_JYNX, POKEMON_ELECTABUZZ, POKEMON_MAGMAR, POKEMON_MAGIKARP, POKEMON_GYARADOS, 
